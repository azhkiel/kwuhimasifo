...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_product'])) {
    ...
    $stmt = $pdo->prepare("INSERT INTO minicanteen_products (name, description, price, stock, image, category_id) VALUES (?, ?, ?, ?, ?, ?)");
...
if (isset($_GET['delete'])) {
    ...
    $stmt = $pdo->prepare("SELECT image FROM minicanteen_products WHERE id = ?");
    $stmt->execute([$id]);
    $product = $stmt->fetch();
    ...
    $stmt = $pdo->prepare("DELETE FROM minicanteen_products WHERE id = ?");
    $stmt->execute([$id]);
...
<head>
    ...
    <title>Kelola Mini Canteen</title>
...
<body class="bg-gray-100">
    <header class="bg-white shadow-md">
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold text-blue-600">Kelola Mini Canteen</h1>
                <nav class="mt-2">
                    <a href="../dashboard.php" class="text-gray-600 hover:text-blue-600 mr-4">Dashboard</a>
                    <a href="index.php" class="text-blue-600 font-semibold mr-4">Mini Canteen</a>
    ...
    <main class="container mx-auto px-4 py-8">
        <div x-data="{ showForm: false }" class="mb-8">
            <button @click="showForm = !showForm" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded mb-4">
                Tambah Produk
            </button>
            ...
            <div x-show="showForm" class="bg-white p-6 rounded-lg shadow-md mb-6">
                ...
                <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="flex justify-end">
                        ...
                        <button type="submit" name="add_product" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">
                            Simpan
                        </button>
                    </div>
                </form>
